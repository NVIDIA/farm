...
Submit and observe in the [dashboard](http://localhost:8222/queue/management/dashboard):

```bash
curl -X POST "http://localhost:8222/queue/management/tasks/submit-graph" \
...
Submit and watch in the [dashboard](http://localhost:8222/queue/management/dashboard):
